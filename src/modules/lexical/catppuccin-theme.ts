export const catppuccinTheme = {
  ...
  list: {
    ...
    ol: 'max-w-md space-y-1 text-subtext-0 list-decimal list-inside',
    ul: 'max-w-md space-y-1 text-subtext-0 list-disc list-inside',
    listitem: 'max-w-md space-y-1 text-subtext-0 list-inside',
    listitemChecked: 'max-w-md space-y-1 text-subtext-0 list-inside text-green',
    listitemUnchecked: 'max-w-md space-y-1 text-subtext-0 list-inside text-red line-through',
  },
  image: '',
  ...
  text: {
    ...
    code: 'font-mono bg-surface-1 p-1 rounded-md',
